...
const EditPassword = () => {
    ...
    const handleSubmit = (event) => {
        ...
        Inertia.post('/confirmEditPassword', { passwordOne, passwordTwo });
    }

    return (
        <div onSubmit={handleSubmit} className="UpdatePasswordContainer cfb">
            ...
            <form className="password-form cfb">
                ...
                je fini edit psd et je passe au easyadmin + ( géré les rôles)
